...
install: ##@system Install package. Don't run it manually!!!
	...
	@sed -i 's/<meta name="version" content="VERSION_PLACEHOLDER">/<meta name="version" content="Version $(VERSION) from $(DATE), build hash $(COMMIT_HASH)">/' $(PATH_PROJECT)/index.php
